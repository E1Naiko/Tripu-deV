...
ORG 2000H
  ...
  ;; --- Estructura for
          ...
          ; ------ COMO MAX = 11, este programa guarda la cantidad de numeros mayores a 11 ------
          CMP MAX, AL ; la operacion cmp compara por medio de la resta de ambos valores, se pueden prender todas las flags
          JNS MINyEQ ; en caso que max<[AL] entonces entra en MINyEQ, ya que si o si cmp<0 -> AL>MAX
