...
;		Se producen en etapa de EX (execute) ya que se intentar guardar los resultados de f3 y f4 cuando
;	no se termino de procesar dichos valores.
;
...
;		Aparece un error WAR porque la instruccion "l.d f2, n2(r0)" no llego a estapa de writeback, 
;	por lo tanto uno de los datos que usa no se termino de cargar.
;
...
;		al agregar la instruccion NOP, se agrega el "delay" justo para que a instruccion l.d f2 ya se encuentre en
;	la etapa WB para cuando se termina de decodificar la instruccion add.d f3
