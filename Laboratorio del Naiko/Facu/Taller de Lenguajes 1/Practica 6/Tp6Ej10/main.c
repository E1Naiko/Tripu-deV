/*
    ...
    menos las siguientes funciones:
        ...
        iv. int s_top (stack s) � Retorna el pr�ximo elemento que ser� desapilado.
        v. int s_empty(stack s) � Retorna 1 si s est� vac�a, 0 en caso contrario.
        vi. int s_length(stack s) � Retorna la cantidad de elementos apilados en s.

    b. Una vez implementadas todas las funciones de biblioteca, escriba un programa que lea n�meros
    enteros y los inserte en una pila. A continuaci�n, desapile los elementos para verificar si funciona
    ...
    que la funci�n s_length retorne la cantidad de elementos sin recorrer la pila.
*/
