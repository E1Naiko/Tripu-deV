...
begin
  while (l<> nil) do begin
        ...
        writeln(' Total de Atleta participantes: ',l^.dato.nombreAtleta, ' Pais: ',l^.dato.Pais);;
        l:= l^.sig;
  end;
end;
...
procedure Informarnombre (a:arboldisciplinas);
var
...
begin
 ...
 Informaratleta(a);
 writeln(' Los nombres de disciplinas que tienen entre 100 y 200 atletas ');
 Informarnombre(a);
